...
HD_PWD='C:/Users/jon/ECE532/tracking/trackin_IP/ip_repo/edit_Tracking_IP_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Tracking_IP_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Tracking_IP_v1_0.tcl
