...
HD_PWD='C:/Users/jon/ECE532/tracking/trackin_IP/ip_repo/edit_Tracking_IP_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Tracking_IP_v1_0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Tracking_IP_v1_0.tcl -notrace
